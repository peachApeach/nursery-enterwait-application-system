...
VALUES ('1', '어피치', '2020-01-01', 'user01', now(), now());

-- 학부모 아이디
INSERT INTO user (user_id, user_password, user_name, user_brithday, user_postal, user_address, code crt_date, chg_date)
VALUES ('user01', 'password002', '아마존', '1980-06-06', '11111', '서울시 관악구 신림동', now(), now());
