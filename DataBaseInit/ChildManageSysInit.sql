...
-- 어린이집 데이터 등록
INSERT INTO peachserver.nursery (nursery_id, nursery_password, nursery_name, nursery_tel, postal_code, address, email, capacity, crt_date, chg_date)
VALUES ('nursery001', 'password001', '가나다 어린이집', '010-1234-5678', 12345, '부산시 해운대구 반여동', 'admin@ganada.com', 50, now(), now());

-- 어린이집 입소 아동 등록
INSERT INTO nur_child (nur_chd_id, nursery_id, child_name, child_birthday, parent_name, parent_tel, parent_address, parent_postcode, parent_email, crt_date, chg_date)
VALUES (1,'abc', '어피치', '2020-01-01', '라이언', '010-0000-0000', '서울시 관악구 신림동', 11111, 'pandayh7@gmail.com', now(), now());
INSERT INTO nur_child (nur_chd_id, nursery_id, child_name, child_birthday, parent_name, parent_tel, parent_address, parent_postcode, parent_email, crt_date, chg_date)
VALUES (2,'abc', '죠르디', '2020-02-02', '앙몬드', '010-1111-2222', '서울시 관악구 남현동', 22222, 'pandayh7@gmail.com', now(), now());
